      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              <div className="w-10 h-10 bg-[#1a472a] rounded-xl flex items-center justify-center overflow-hidden">
                <Image src="/logo.png" alt="SARV" width={32} height={32} className="object-contain scale-75" />
              </div>
              <div className="leading-none">
                <span className="font-black text-[18px] text-white leading-none block">SARV</span>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2">
              <p className="text-[13px] text-white/45">info@sarv.tj</p>
        ...
        <div className="mt-12 pt-6 border-t border-white/8 flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-[11px] text-white/25">
            © {new Date().getFullYear()} SARV Agro Platform. {F.rights[lang]}.
          </p>

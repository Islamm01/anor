  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-24 text-center">
      ...
      <div className="flex justify-center gap-3">
        ...
        <a href="mailto:info@sarv.tj" className="px-7 py-3.5 border border-black/12 text-black text-[14px] font-semibold rounded-full hover:bg-black/4 transition-colors">
